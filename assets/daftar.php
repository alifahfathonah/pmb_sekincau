<!DOCTYPE html>
<!-- saved from url=(0041)http://daftar.spmb.teknokrat.ac.id/daftar -->
<html>
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <div class="tab-content">
                <form action="http://daftar.spmb.teknokrat.ac.id/Akun" method="post">
            ...
            <a href="http://daftar.spmb.teknokrat.ac.id/login">Login</a>
            <br>
            <!-- <a href="">Home</a> -->
        </div>
        <!-- /.login-box-body -->
